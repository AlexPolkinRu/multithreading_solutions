...
Сравни каждый критерий по отдельности,
 чтобы победителем был пляж с лучшими показателями по большинству критериев.
...
public class Beach implements Comparable<Beach> {
    ...
    public synchronized int compareTo(Beach anotherBeach) {
        ...
        criteria1 = Integer.compare(getQuality(), anotherBeach.getQuality());
        criteria2 = Float.compare(anotherBeach.getDistance(), getDistance());
